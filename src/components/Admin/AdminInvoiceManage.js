...
const AdminViewandEditInvoice1 = () => {
  ...
  return (
    <div>
      <button onClick={openModal}>Select Invoice</button>
      <Modal
        isOpen={isModalOpen}
        onRequestClose={closeModal}
        contentLabel="Select Invoice"
      >
        ...
        <div className="invoice-container-first">
          <div className="invoice-container-first-left">
            <p className="invoice-container-first-left-companyname">{selectedInvoice.companydetails.companyname}</p>
            <p className="invoice-container-first-left-companyaddress">Ground Floor,Shop No 67,Padmawati NagarB. Bhadarna,JAIPUR - 302013,RAJASTHAN</p>
          ...
          <div className="invoice-container-first-right">
            <p className="invoice-container-first-right-taxinvoice">TAX INOVICE</p>
        ...
        <div className="invoice-container-second">
          ...
          <div className="invoice-container-second-right">
            ...
            <p className='invoice-container-second-right-invoice'><span className='head'>invoice no</span></p>
            </div>
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>e-way no</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>dated</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>10-11-2023</p>
            </div>
            </div>
            <hr className="invoice-container-second-right-hr" />
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>delivery note</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>mode/terms of payment</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>suppilers ref</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>--</p>
            </div>
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>other reference(s)</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>--</p>
            </div>
            ...
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>05-11-2023</p>
            </div>
            </div>
            <hr className="invoice-container-second-right-hr" />
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>dispatch document no</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>delivery note date</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>12-11-2023</p>
            </div>
            </div>
            <hr className="invoice-container-second-right-hr" />
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>dispatched through</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>Courier</p>
            </div>
            </div>
            <hr className="invoice-container-second-right-hr" />
            <div className="invoice-container-second-right-things">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>Destination</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            ...
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>BILL LAnding/LR-RR No</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>RND089687</p>
            </div>
            </div>
            <hr className="invoice-container-second-right-hr" />
            <div className="invoice-container-second-right-things">
              <div className="invoice-container-second-right-things-sno">
            <p className='invoice-container-second-right-invoice'><span className='head'>MOTOR Vehicle number</span></p>
            </div>
            <div className="invoice-container-second-right-things-value">
            <p className='invoice-container-second-right-invoice'>RJBF89A0879</p>
            </div>
            </div>
            </div>
        </div>
          ...
          <table className="invoice-container-third-table">
            <thead className="invoice-container-third-table-head">
              <tr className="invoice-container-third-table-head-tr">
                <th className="invoice-container-third-table-head-tr-th">S.No</th>
                <th className="invoice-container-third-table-head-tr-th">Description of Goods</th>
                <th className="invoice-container-third-table-head-tr-th">HSN/SAC</th>
                <th className="invoice-container-third-table-head-tr-th">Quantity</th>
                <th className="invoice-container-third-table-head-tr-th">Rate</th>
                <th className="invoice-container-third-table-head-tr-th">per</th>
                <th className="invoice-container-third-table-head-tr-th">Amount</th>
              </tr>
              </thead>
              ...
              <tbody className="invoice-container-third-table-body">
                <tr className="invoice-container-third-table-body-tr">
                  ...
                  <td className="invoice-container-third-table-body-tr-td">scrap</td>
                  <td className="invoice-container-third-table-body-tr-td">1234</td>
                  <td className="invoice-container-third-table-body-tr-td">100</td>
                  <td className="invoice-container-third-table-body-tr-td">18</td>
                  <td className="invoice-container-third-table-body-tr-td">100</td>
                  <td className="invoice-container-third-table-body-tr-td">118</td>
                  </tr>
                  ...
                  <td className="invoice-container-third-table-body-tr-td">TOTAL</td>
                  <td className="invoice-container-third-table-body-tr-td"></td>
                  <td className="invoice-container-third-table-body-tr-td"></td>
                  <td className="invoice-container-third-table-body-tr-td"></td>
                  <td className="invoice-container-third-table-body-tr-td"></td>
        ...
        <table className="invoice-container-fourth-table">
            <thead className="invoice-container-fourth-table-head">
              <tr className="invoice-container-fourth-table-head-tr">
                <th className="invoice-container-fourth-table-head-tr-th">S.No</th>
                <th className="invoice-container-fourth-table-head-tr-th">HSN/SAC</th>
                <th className="invoice-container-fourth-table-head-tr-th">TAXABLE VALUE</th>
                  <th className="invoice-container-fourth-table-head-tr-th">RATE</th>
                <th className="invoice-container-fourth-table-head-tr-th">AMOUNT</th>
                <th className="invoice-container-fourth-table-head-tr-th">TOTAL TAX AMOUNT</th>
              </tr>
              </thead>
              ...
              <tbody className="invoice-container-fourth-table-body">
                <tr className="invoice-container-fourth-table-body-tr">
                  ...
                  <td className="invoice-container-fourth-table-body-tr-td">1234</td>
                  <td className="invoice-container-fourth-table-body-tr-td">100</td>
                  <td className="invoice-container-fourth-table-body-tr-td">18</td>
                  <td className="invoice-container-fourth-table-body-tr-td">100</td>
                  <td className="invoice-container-fourth-table-body-tr-td">118</td>
                  </tr>
                  ...
                  <td className="invoice-container-fourth-table-body-tr-td">TOTAL</td>
                  <td className="invoice-container-fourth-table-body-tr-td"></td>
                  <td className='invoice-container-fourth-table-body-tr-td'></td>
                  <td className="invoice-container-fourth-table-body-tr-td"></td>
                  <td className="invoice-container-fourth-table-body-tr-td">118</td>
        ...
        <div className="invoice-container-fifth">
          <div className="invoice-container-fifth-left">
            ...
            <p className='invoice-container-fifth-left-content-value'>WE DECLARED THAT THIS INVOICE SHOWS THE ACTUAL PRICE
                      OF THE GOOD DESCRIBED AND THAT ALL PARTICULAR ARE</p>
            </div>
          ...
          <p className='invoice-container-fifth-end'>This is a computer generated invoice.</p>
    </div>
...
export default AdminViewandEditInvoice1;
